          ...
          if (searchText != "") {
            $.ajax({
              ...
              Object.keys(obj).forEach((item) => {
                nova_linha += '<button  class=" list-group-item list-group-item-action " id="donoTelefone' + obj[item].telefone + '_donoCPF' + obj[item].cpf + '_donoCodigo' + obj[item].id + '">' + obj[item].nome + '</button><span></span>'
              });
